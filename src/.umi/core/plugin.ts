...
import * as Plugin_0 from 'D:/github/ai/Claude-code-demo1/src/app.tsx';
  ...
  return [
    {
      ...
      path: process.env.NODE_ENV === 'production' ? void 0 : 'D:/github/ai/Claude-code-demo1/src/app.tsx',
    },
    {
      apply: Plugin_1,
